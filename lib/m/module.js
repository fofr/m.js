...
(function (m, _) {
  var Module = m.utils.inherit(m.Events, {
     ...
     */
    emit: function (topic) {
      m.Events.prototype.emit.apply(this, arguments);

      var hub = this.options.dependencies && this.options.dependencies.hub;
      var args = Array.prototype.slice.call(arguments, 1);
      if (hub) {
        hub.publish.apply(hub, ['module:' + topic].concat(args));
      }
      return this;
    },
  ...
  var ModuleFactory = m.create({
     ...
     *
     *   // As arguments.
     *   module('my-module').requires('api', 'hub', 'dom');
     *
     *   // As an array.
     *   var dependencies = ['api', 'hub'];
     *   module('my-module').requires(dependencies);
     *
     * Returns itself.
     */
    requires: function (name) {
      var dependencies = _.isArray(name) ? name : _.toArray(arguments);
  ...
  var ModuleRegistry = m.create({
    /* A Library instance containing all dependancies */
    library: null,
     ...
     * Returns nothing.
     */
    constructor: function ModuleRegistry(library) {
    ...
    instance: function (factory, element, options, event) {
      ...
      var dependencies = this.library.require(factory.dependencies);
