...
define(function (require, exports) {
  ...
  var LibraryRegistry = util.create({
   ...
   * object provided.
   */
  var LibraryModuleDependencies = util.create({
    instances: null,
    dependencies: null,
    library: null,
  ...
  exports.libraries = new LibraryRegistry();
  exports.LibraryRegistry = LibraryRegistry;
  exports.LibraryModuleDependencies = LibraryModuleDependencies;
